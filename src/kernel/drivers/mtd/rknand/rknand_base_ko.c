...
EXPORT_SYMBOL(GetIdBlockSysData);
...
EXPORT_SYMBOL(GetVendor0InfoBeforeNandInit);
...
EXPORT_SYMBOL(GetChipSectorInfo);
...
EXPORT_SYMBOL(GetflashDataByLba);
