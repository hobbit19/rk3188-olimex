...
{
    int rc;
    if ((rc = dhd_module_init()) == 0)
    {
        printk(KERN_NOTICE "=======================================================\n");
        printk(KERN_NOTICE "==== Launching Wi-Fi driver! (Powered by Rockchip) ====\n");
        printk(KERN_NOTICE "=======================================================\n");
        printk(KERN_NOTICE "%s WiFi driver (Powered by Rockchip,Ver %s) init.\n",
...
{
    printk(KERN_NOTICE "=======================================================\n");
    printk(KERN_NOTICE "== Dis-launching Wi-Fi driver! (Powered by Rockchip) ==\n");
    printk(KERN_NOTICE "=======================================================\n");
    dhd_module_cleanup();
}
